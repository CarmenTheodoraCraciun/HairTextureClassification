...
def preprocess_images(input_dir, output_dir, size=(224, 224)):
    ...
    for category in os.listdir(input_dir):
        ...
        # Verifică dacă category_dir este un director
...
def preprocess_and_augment_image(img, size=(224, 224), rescale=1./255, shear_range=0.2, zoom_range=0.2, horizontal_flip=True):
    ...
    # Asigurarea dimensiunilor originale după zoom
    if zoom_factor < 1:
